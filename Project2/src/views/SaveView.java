...
public class SaveView {
    ...
    public void saveBoard() {
        String fn = saveFileNameTextField.getText();
        int len = fn.length();
        ...
        if(fn.substring(len-4).equals(".ser")){
            tetrisView.model.saveModel(new File("boards/"+fn));
            saveBoardLabel.setText(saveFileSuccess);
        }else {
